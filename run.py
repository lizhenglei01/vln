...
def run_exp(run_type: str, exp_config: str, split_id: int, split_num: int, save_path: str, model_path: str,
            model_name: str, opts: None) -> None:
    if run_type == "eval":
        if model_name == 'uni-navid':
            ...
            from uninavid.constants import IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, \
