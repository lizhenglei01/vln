...
def main():
    ...
    parser.add_argument(
        ...
        default="habitat-lab/habitat/config/benchmark/nav/track/track_infer_at.yaml",  # 默认配置文件路径
    )
    ...
    parser.add_argument(
        ...
        type=str,
        # required=True,
        default="exp_results/uninavid_all/at1",  # 默认保存路径
    )
